...
const MCQQuiz = () => {
  ...
  useEffect(() => {
    if (user) {
      axios
        .get(`${import.meta.env.VITE_API_URL}/api/results/check/${user.id}/${id}`)
        .then((res) => {
  ...
  useEffect(() => {
    if (!alreadyAttempted) {
      axios
        .get(`${import.meta.env.VITE_API_URL}/api/question/course/${id}`)
        .then((res) => {
  ...
  const handleSubmit = async () => {
    ...
    for (let q of questions) {
      ...
      await axios.post(`${import.meta.env.VITE_API_URL}/api/quiz-answers`, payload);
    }
    ...
    await axios.post(`${import.meta.env.VITE_API_URL}/api/results`, resultPayload);
